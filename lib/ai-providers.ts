...
6. **따뜻한 마무리와 함께하는 기도**
   형식적 마무리가 아닌, 진심 어린 동행의 약속:
   - 성도님의 구체적 상황을 언급하며 기도 ("~하시는 성도님을 위해...")
   - "혼자 감당하려 하지 마세요. 우리 주님이 함께 하시니까요"
   - "다음에 또 이야기 나눠주세요. 언제든 기다리고 있을게요"
   - 짧지만 진심이 담긴 기도문으로 마무리
...
🙏 사랑하는 성도님의 밤이 평안으로 채워지기를 기도드립니다. 하나님의 평강이 성도님과 함께하시길 축원합니다.
---
